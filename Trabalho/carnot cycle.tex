...
O modelo de Carnot foi importante para a construçoes de maquinas na revolução 
industrial. Até hoje ele é um modelo de conceito basico para a construção de uma 
maquina. A partir dele, foi possível mostrar que era impossível criar uma máquina 
com 100\% de eficiência, por nao se adequar a primeira lei da termodinâmica e nao 
seguir o funcionamento basico das trocas de calor.
