...
\bibitem{1} Nascimento, C.K., Braga, J.P., \& Fabris, J.D. (2004). \emph{Reflexões sobre a contribuição de Carnot à primeira lei da termodinâmica}. SciELO Brasil.
\bibitem{2} Hall, N. (2021). \emph{Ideal Carnot Cycle}. NASA Glenn Research Center.
\bibitem{3} Hall, N. (2021). \emph{Specific Heats}. NASA Glenn Research Center.
\bibitem{4} Hall, N. (2021). \emph{Specific Heat Capacity}. NASA Glenn Research Center.
\bibitem{5} LibreTexts. \emph{Carnot Cycle}.
\end{thebibliography}
