...
Finalmente, com esse resultado, podemos escrever, da \cref{adiab_tv_const} e \cref{def_gamma}:
...
Para encontrar a eficiência, dividimos esse trabalho total pelo calor absorvido pelo motor. E sabemos que 
esse calor é igual ao trabalho realizado pela expansão isotérmica, pois como não há variação de temperatura,
também não haverá variação de energia interna. Da primeira lei da termodinâmica, podemos afirmar então
que todo o calor absorvido é convertido em trabalho, e vice-versa!
...
\bibitem{1} Nave, C.R. \emph{Carnot Cycle Concepts}. Georgia State University
\bibitem{2} Nascimento, C.K., Braga, J.P., \& Fabris, J.D. (2004). \emph{Reflexões sobre a contribuição de Carnot à primeira lei da termodinâmica}. SciELO Brasil.
\bibitem{3} Hall, N. (2021). \emph{Ideal Carnot Cycle}. NASA Glenn Research Center.
\bibitem{4} Hall, N. (2021). \emph{Specific Heats}. NASA Glenn Research Center.
\bibitem{5} Hall, N. (2021). \emph{Specific Heat Capacity}. NASA Glenn Research Center.
\bibitem{6} LibreTexts. \emph{Carnot Cycle}.
\end{thebibliography}
